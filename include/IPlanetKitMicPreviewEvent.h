...
namespace PlanetKit {
    ...
    public:
        virtual ~IMicPreviewEvent() {};
        /**
         * Event for receiving the current incoming volume level of the microphone device.
         * @param fVolume Volume level incoming to the microphone device.
         */
