...
namespace PlanetKit {
    ...
    class PLANETKIT_API ConferenceVideoUpdatedParam {
    public:
        virtual ~ConferenceVideoUpdatedParam() { }
    ...
    typedef SharedPtr<ConferenceVideoUpdatedParam> ConferenceVideoUpdatedParamPtr;
};