...
namespace PlanetKit
{
    ...
    public:
        ...
        * @return true on success
        */
        virtual bool GetPeakValue(float *fVolume) { return false; }
        ...
        */
         ...
         */
        bool PlayFile(const char* szPath, unsigned int unLoop);

        /**
         * Plays the local audio file.
         * @param szPath Audio file path
         * @param unLoop Number of times to repeat playing the audio file
         */
        virtual bool PlayFile(const wchar_t* szPath, unsigned int unLoop) = 0;
